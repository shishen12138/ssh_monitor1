...
mv host_manager.py host_manager/manager.py
mv ssh_client.py ssh_client/ssh.py
mv monitoring.py monitoring/monitor.py
mv aws_importer.py aws_importer/importer.py
mv logger.py logger/logger.py
mv web_routes.py web_panel/routes.py
